  ...
  return (
    <section id="contato" className="py-16 md:py-20 bg-white">
      <div className="container-custom">
        <div className="relative bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-3xl overflow-hidden p-8 md:p-14 text-center">
          {/* Decorative circles */}
          ...
          <div className="relative z-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-white text-[#128C7E] hover:bg-gray-50 font-black text-base md:text-lg py-4 px-10 rounded-2xl transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-xl"
            >

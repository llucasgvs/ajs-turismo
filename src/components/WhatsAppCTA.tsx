        ...
        <div className="relative bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-2xl sm:rounded-3xl overflow-hidden p-6 sm:p-8 md:p-14 text-center">
          ...
          <div className="relative z-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 sm:gap-3 bg-white text-[#128C7E] hover:bg-gray-50 font-black text-sm sm:text-base md:text-lg py-4 px-6 sm:px-10 rounded-2xl transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-200 hover:-translate-y-1 shadow-lg hover:shadow-xl"
            >

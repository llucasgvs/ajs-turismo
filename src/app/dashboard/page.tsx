      ...
      <div className="px-5 py-4 border-b border-dashed border-gray-200 flex items-center gap-4">
        {days !== null && (
          <div className="print:hidden shrink-0 flex flex-col items-center justify-center bg-navy-50 rounded-xl px-4 py-3 min-w-[72px]">
            {days <= 0 ? (
              ...
              <p className="font-display font-black text-lg leading-none text-navy-800">Amanhã</p>
            ) : (
              <>
                <p className="text-[9px] uppercase tracking-wide text-gray-400 font-semibold">faltam</p>
                <p className="font-display font-black text-2xl leading-none text-navy-800 mt-0.5">{days}</p>
        ...
        <div className="flex-1 min-w-0 flex flex-col justify-center gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          ...
          <div className="sm:text-right">
            ...
            <p className="font-mono font-black text-navy-800 tracking-wider text-sm sm:text-base">{b.booking_code}</p>
          </div>
        </div>
      </div>
